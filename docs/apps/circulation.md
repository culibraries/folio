...
## Renew (all) items for a specific user
...
1. Check box to the left of *Item Title* to select all items. If only certain items need renewed, only select those items.
1. Click **Renew**
